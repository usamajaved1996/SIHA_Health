    ...
    return (
      <Card style={styles.reimbursementCard}>
        <View style={styles.headerStyle}>
          ...
          <TouchableOpacity
            onPress={() => {
              navigation.navigate('DetailsScreen', { screenName: 'reimbursement', screenId: item.ClaimId });
            }}
        ...
        <View style={styles.mainViewContact}>
          ...
          <View style={{ width: '40%', paddingTop: 6 }}>
            ...
            <View style={styles.contributionView}>
              ...
              <View style={styles.borderStyle}>
                <Text style={[styles.font.regular, { fontSize: 11, color: styles.fontColors.grey }]} >Requested: {item.Requested}</Text>
